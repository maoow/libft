...
## char *ft_itoa(int nb);
Allocate and returns a “fresh” string ending
with ’\0’ representing the integer nb given as argument.
Negative numbers must be supported. If the allocation fails,
the function returns NULL.

## char *ft_itoabase(unsigned int nb, char *base);
Allocate and returns a “fresh” string ending
with ’\0’ representing the integer nb given as argument in the base given by the second argument formated as string.
Negative numbers must be supported. If the allocation fails,
the function returns NULL.
...
as argument to create a “fresh” new string resulting from the successive applications of f.

## char *ft_strmapi(char const *s, char (*f)(unsigned int, char));
Applies the function f to each character of the string passed
as argument by giving its index as first argument to create a
“fresh” new string resulting from the successive
applications of f.
...
Allocates and returns a “fresh” memory
...
n Takes as a parameter the address of a memory area that needs
